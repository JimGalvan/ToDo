...
public class ToDoController {
	...
	@FXML private GridPane addTaskPanel;
	@FXML private VBox gridPane;
	@FXML private TableView<ToDoTask> tableView;
	@FXML private TableColumn<ToDoTask, String> taskColumn;
	@FXML private TableColumn<ToDoTask, String> timeColumn;
	@FXML private TextField nameTextField;
	@FXML private Spinner<Integer> hourSelector;
	@FXML private Spinner<Integer> minSelector;
	...
	private void setUpTimer() {
		...
		hourSelector.setValueFactory(new SpinnerValueFactory.
				IntegerSpinnerValueFactory(0, 24, 0));
		minSelector.setValueFactory(new SpinnerValueFactory.
				IntegerSpinnerValueFactory(0, 60, 0));
	}
